...
var Characteristic = React.createClass({
  handleChange: function() {
    var author = this.refs.value.getDOMNode().value.trim();
...
var DiamondForm = React.createClass({
  render: function() {
    return (
      <form>
        <Characteristic name="Carat" min="0" max="4" interval=".1" />
        <Characteristic name="Color" min="105" max="115" interval="1" />
        <Cost />
      </form>
    );
  }
